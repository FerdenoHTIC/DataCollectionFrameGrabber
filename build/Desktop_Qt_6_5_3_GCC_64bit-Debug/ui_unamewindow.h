...
public:
    ...
    void setupUi(QMainWindow *UnameWindow)
    {
        ...
        logo_image->setGeometry(QRect(310, 250, 400, 400));
        logo_image->setStyleSheet(QString::fromUtf8("image: url(:/img/images/anu.png);"));
        frame = new QFrame(centralwidget);
        frame->setObjectName("frame");
        frame->setGeometry(QRect(800, 270, 920, 370));
        ...
        password_text->setFocusPolicy(Qt::StrongFocus);
...
""));
        ...
        auth_login->setFocusPolicy(Qt::NoFocus);
...
""));
        ...
        username_text->setFocusPolicy(Qt::StrongFocus);
...
"}\n"
""));
        username_text->setEchoMode(QLineEdit::Normal);
        label = new QLabel(centralwidget);
        label->setObjectName("label");
        label->setGeometry(QRect(800, 200, 910, 70));
        QFont font2;
